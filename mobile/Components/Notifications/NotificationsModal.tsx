...
const NotificationsModal = (props) => {
  ...
  return (
    <View style={{ alignItems: "center", paddingTop: 20 }}>
      <Text style={{ fontSize: 25 }}>Notification Settings</Text>
      ...
      >
        ...
        <View style={{ flex: 2 }}>
          <Switch
            ...
            ios_backgroundColor="#3e3e3e"
            onValueChange={() => {
              setNotifFriendReq(!notifFriendReq);
              setChanged(true);
            }}
      ...
      <View style={{ marginTop: 20 }}>
        <Button
          onPress={() => {
            saveNotifs(notif, notifFriend, notifFriendReq, setChanged);
            navigation.goBack();
          }}
          disabled={!changed}
          mode={"outlined"}
